...
B Type__eq(void *t1, void *t2) {
  ...
  switch (type) {
    ...
    case TTuple2_66F7BA: return Tuple2_66F7BA__eq((Tuple2_66F7BA) t1, (Tuple2_66F7BA) t2);
    ...
    case TMS_1E4216: return MS_1E4216__eq((MS_1E4216) t1, (MS_1E4216) t2);
    case TMS_D1ED39: return MS_D1ED39__eq((MS_D1ED39) t1, (MS_D1ED39) t2);
    ...
    case TNone_C92EDC: return None_C92EDC__eq((None_C92EDC) t1, (None_C92EDC) t2);
    case TNone_C2CCA4: return None_C2CCA4__eq((None_C2CCA4) t1, (None_C2CCA4) t2);
    ...
    case TNone_FD0D39: return None_FD0D39__eq((None_FD0D39) t1, (None_FD0D39) t2);
    case TNone_72E81E: return None_72E81E__eq((None_72E81E) t1, (None_72E81E) t2);
    case TNone_892E2E: return None_892E2E__eq((None_892E2E) t1, (None_892E2E) t2);
    ...
    case TSome_3EC8A4: return Some_3EC8A4__eq((Some_3EC8A4) t1, (Some_3EC8A4) t2);
    ...
    case TSome_A13654: return Some_A13654__eq((Some_A13654) t1, (Some_A13654) t2);
    case TSome_2040D2: return Some_2040D2__eq((Some_2040D2) t1, (Some_2040D2) t2);
    case TSome_040EE4: return Some_040EE4__eq((Some_040EE4) t1, (Some_040EE4) t2);
    ...
    case Tops_ISZOps_524353: return ops_ISZOps_524353__eq((ops_ISZOps_524353) t1, (ops_ISZOps_524353) t2);
    ...
    case Tt_Cli: return t_Cli__eq((t_Cli) t1, (t_Cli) t2);
    case Tt_Cli_HelpOption: return t_Cli_HelpOption__eq((t_Cli_HelpOption) t1, (t_Cli_HelpOption) t2);
    case Tt_Cli_RunOption: return t_Cli_RunOption__eq((t_Cli_RunOption) t1, (t_Cli_RunOption) t2);
...
void Type_cprint(void *this, B isOut) {
  ...
  switch (type) {
    ...
    case TTuple2_66F7BA: Tuple2_66F7BA_cprint((Tuple2_66F7BA) this, isOut); return;
    ...
    case TMS_1E4216: MS_1E4216_cprint((MS_1E4216) this, isOut); return;
    case TMS_D1ED39: MS_D1ED39_cprint((MS_D1ED39) this, isOut); return;
    ...
    case TNone_C92EDC: None_C92EDC_cprint((None_C92EDC) this, isOut); return;
    case TNone_C2CCA4: None_C2CCA4_cprint((None_C2CCA4) this, isOut); return;
    ...
    case TNone_FD0D39: None_FD0D39_cprint((None_FD0D39) this, isOut); return;
    case TNone_72E81E: None_72E81E_cprint((None_72E81E) this, isOut); return;
    case TNone_892E2E: None_892E2E_cprint((None_892E2E) this, isOut); return;
    ...
    case TSome_3EC8A4: Some_3EC8A4_cprint((Some_3EC8A4) this, isOut); return;
    ...
    case TSome_A13654: Some_A13654_cprint((Some_A13654) this, isOut); return;
    case TSome_2040D2: Some_2040D2_cprint((Some_2040D2) this, isOut); return;
    case TSome_040EE4: Some_040EE4_cprint((Some_040EE4) this, isOut); return;
    ...
    case Tops_ISZOps_524353: ops_ISZOps_524353_cprint((ops_ISZOps_524353) this, isOut); return;
    ...
    case Tt_Cli: t_Cli_cprint((t_Cli) this, isOut); return;
    case Tt_Cli_HelpOption: t_Cli_HelpOption_cprint((t_Cli_HelpOption) this, isOut); return;
    case Tt_Cli_RunOption: t_Cli_RunOption_cprint((t_Cli_RunOption) this, isOut); return;
...
void Type_string_(STACK_FRAME String result, void *this) {
  ...
  switch (type) {
    ...
    case TTuple2_66F7BA: Tuple2_66F7BA_string_(CALLER result, (Tuple2_66F7BA) this); return;
    ...
    case TMS_1E4216: MS_1E4216_string_(CALLER result, (MS_1E4216) this); return;
    case TMS_D1ED39: MS_D1ED39_string_(CALLER result, (MS_D1ED39) this); return;
    ...
    case TNone_C92EDC: None_C92EDC_string_(CALLER result, (None_C92EDC) this); return;
    case TNone_C2CCA4: None_C2CCA4_string_(CALLER result, (None_C2CCA4) this); return;
    ...
    case TNone_FD0D39: None_FD0D39_string_(CALLER result, (None_FD0D39) this); return;
    case TNone_72E81E: None_72E81E_string_(CALLER result, (None_72E81E) this); return;
    case TNone_892E2E: None_892E2E_string_(CALLER result, (None_892E2E) this); return;
    ...
    case TSome_3EC8A4: Some_3EC8A4_string_(CALLER result, (Some_3EC8A4) this); return;
    ...
    case TSome_A13654: Some_A13654_string_(CALLER result, (Some_A13654) this); return;
    case TSome_2040D2: Some_2040D2_string_(CALLER result, (Some_2040D2) this); return;
    case TSome_040EE4: Some_040EE4_string_(CALLER result, (Some_040EE4) this); return;
    ...
    case Tops_ISZOps_524353: ops_ISZOps_524353_string_(CALLER result, (ops_ISZOps_524353) this); return;
    ...
    case Tt_Cli: t_Cli_string_(CALLER result, (t_Cli) this); return;
    case Tt_Cli_HelpOption: t_Cli_HelpOption_string_(CALLER result, (t_Cli_HelpOption) this); return;
    case Tt_Cli_RunOption: t_Cli_RunOption_string_(CALLER result, (t_Cli_RunOption) this); return;
